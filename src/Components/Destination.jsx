...
const Destination = () => {
    return (
        <div className="py-10">
            <h2 className="text-xl lg:text-3xl py-2 border-b-2 border-blue-950 lg:mx-96 text-center text-[#190482] font-bold ">Top <span className="text-sky-700">Destination</span></h2>
            ...
            <div className='grid grid-cols-2 gap-4 lg:grid-cols-4 px-10'>
